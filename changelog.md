...
| ------- | ---- | --- | --------- |
| [v0.8.0.post2](https://github.com/romanin-rf/SeaPlayer/releases/tag/v0.8.0.post2) | 07.12.2023 | **STABLE** | - Added a new experimental `PopUp` widget (pop-up window)<br>- Added new exception type `Error`<br>- Added language loader system<br>- Added full translate: English, Русский<br>- Changed CSS for `LogMenu`<br>- Updated `build.py`<br>- Fixed: `self.last_playback_status` not is int<br>- Removing excess in `DataOptions` (from past updates)<br>- Deprecated method `seaplayer.functions.check_status` |
| [v0.8.0.post1](https://github.com/romanin-rf/SeaPlayer/releases/tag/v0.8.0.post1) | 03.12.2023 | **STABLE** | - Added `changelog.md`<br>- Added `secrets`<br>- Added widgets: `DataRadioButton`, `ClikableButton` and `Rheostat (experemental)`<br>- Renamed `*.css` files to `.tcss`<br>- The first part of the attempts to make the `Configurate Screen` understandable to the average user |
